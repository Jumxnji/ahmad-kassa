      ...
      <Container width="ultra" className="pt-20 pb-16 sm:pt-24 sm:pb-20">
        <div className="flex flex-col gap-14 lg:flex-row lg:items-start lg:justify-between">
          <div className="lg:w-[38%]">
            <Logo tone="inverted" />
            <p className="mt-6 max-w-md font-display text-2xl leading-snug text-balance text-paper-50/90 italic sm:text-3xl">
              {SITE_TAGLINE}.
            </p>
          </div>

          <div
            className={`grid gap-x-16 gap-y-10 border-t border-paper-50/10 pt-14 lg:w-[52%] lg:border-t-0 lg:pt-0 ${
